...
import cs362.CommandLineUtilities;
...
public class RemoveImageNoise {
	...
	public static void main(String[] args) {
		...
		//String input_image = "data\\data\\eugene.noisy2.bmp";
		...
		//String output_image = "easy.1.2_colors.output.bmp";
		...
		/*
		BufferedImage buffered_real_image = ImageUtils.loadImage("data\\data\\eugene.noisy2.bmp");
		
		int[][] real_image_array = ImageUtils.convertImageToIntArray(buffered_image);
		
		ImageUtils.compareImages(decoded_image_array, real_image_array);
		*/
